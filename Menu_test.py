...
def main():
    ...
    TASK_FILE = os.path.join(BASE_DIR, "ToDo_Martin.txt")
    ...
    while True:
        ...
        if choice == "add":
            ...
            if new_text:
                tasks.append({"text": new_text.strip().capitalize(), "done": False})
        ...
        # TOGGLE DONE / NOT DONE
            ...
            if not tasks:
                print_formatted_text(HTML("<ansired>No tasks to update.</ansired>"))
                continue

            values = [(str(i), task["text"]) for i, task in enumerate(tasks, 1)]
        ...
        # REMOVE
            ...
            if not tasks:
                print_formatted_text(HTML("<ansired>No tasks to remove.</ansired>"))
                continue
        ...
        # CLEAR ALL
            ...
            if confirm:
                tasks = []
                print_formatted_text(HTML("<ansired>All tasks cleared.</ansired>"))
